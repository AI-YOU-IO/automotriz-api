...
const doc = {
  ...
  tags: [
    ...
    { name: 'Proyecto', description: 'Gestion de proyectos' },
    { name: 'RolModulo', description: 'Relacion rol-modulo' },
    { name: 'Speaker', description: 'Gestion de speakers' },
    { name: 'Tipologia', description: 'Gestion de tipologias' },
    { name: 'TipoPlantilla', description: 'Tipos de plantilla' },
    { name: 'Transcripcion', description: 'Gestion de transcripciones' },
    { name: 'Unidad', description: 'Gestion de unidades' },
